-- Static geography: region_states.state_id and users geo columns store CSV codes,
-- not rows in states/districts master tables.
...
-- Remap legacy UUID references to CSV codes when master tables still exist.
DO $$
BEGIN
